...
(function () {
  ...
  const DICT = {
    ar: {
      ...
      mood_hope: 'أمل', mood_nostalgia: 'حنين', mood_secret: 'سر', mood_confession: 'اعتراف', mood_bold: 'جرأة',       mood_love: 'حب', mood_dream: 'حلم', mood_wisdom: 'حكمة',
    ...
    en: {
      ...
      mood_hope: 'Hope', mood_nostalgia: 'Nostalgia', mood_secret: 'Secret', mood_confession: 'Confession', mood_bold: 'Bold',       mood_love: 'Love', mood_dream: 'Dream', mood_wisdom: 'Wisdom',
