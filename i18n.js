...
(function () {
  ...
  const DICT = {
    ar: {
      ...
      mood_love: 'حب', mood_hope: 'أمل', mood_dream: 'حلم', mood_wisdom: 'حكمة', mood_motivation: 'تحفيز', mood_nostalgia: 'حنين', mood_secret: 'سر', mood_confession: 'اعتراف', mood_bold: 'جرأة',
      ...
      /* ✅ رسائل أخطاء جديدة — واضحة ومفهومة */
      e_EMPTY_TEXT: 'لا يمكن إرسال رسالة فارغة.',
      e_TEXT_TOO_LONG: 'النص طويل جدًا (الحد 300 حرف).',
      e_ARRIVAL_REQUIRED: 'اختر موعد الوصول للكبسولة الخاصة.',
      e_RATE_LIMITED_DAILY: 'وصلت للحد اليومي (5 كبسولات). عد غدًا لإرسال المزيد.',
      e_RATE_LIMITED_COOLDOWN: 'انتظر 30 ثانية قبل إرسال كبسولة أخرى.',
    ...
    en: {
      ...
      /* ✅ New error messages — clear and user-friendly */
      e_EMPTY_TEXT: 'Cannot send an empty message.',
      e_TEXT_TOO_LONG: 'Text too long (max 300 characters).',
      e_ARRIVAL_REQUIRED: 'Please choose an arrival date for your private capsule.',
      e_RATE_LIMITED_DAILY: 'You reached the daily limit (5 capsules). Come back tomorrow.',
      e_RATE_LIMITED_COOLDOWN: 'Wait 30 seconds before sending another capsule.',
